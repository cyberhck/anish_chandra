...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    var k, b = "Codrops-Gannon",
        c = "DrawSVGPlugin",
        d = "greensock.com",
        e = "/requires-membership/",
        f = function(a) {
            for (var b = (window ? window.location.href : "").substr(0, 5) === "file:" || -1 !== a.indexOf("localhost"), e = [d, "codepen.io", "cdpn.io", "gannon.tv", 'codecanyon.net', "themeforest.net", "cerebrax.co.uk"], f = e.length; --f > -1;)
                if (-1 == a.indexOf(e[f])) return !0;
            return b && window.console && console.log("Warning"), b
